...
namespace Global.CarManagement.UnitTest.Application.Features.Cars.Commands.UpdateCar
{
    public class UpdateCarHandlerUnitTest
    {
        ...
        {
            var CarCommand = _fixture.Create<UpdateCarCommand>();
            ...
            _CarRepository.Verify(x => x.UpdatePartial(It.IsAny<Car>()), Times.Once);
        ...
        {
            var CarCommand = _fixture.Create<UpdateCarCommand>();
            _CarRepository.Setup(x => x.UpdatePartial(It.IsAny<Car>())).Throws(new Exception());
            _CarRepository.Setup(x => x.ExistsAsync(It.IsAny<Guid>())).ReturnsAsync(true);
            _CarRepository.Setup(x => x.ExistsAsync(It.IsAny<string>(), It.IsAny<Guid>(), It.IsAny<Guid>())).ReturnsAsync(false);
        ...
        [Fact]
        public async Task Car_Should_Not_Be_Updated_When_Name_Already_Exists()
        {
            var CarCommand = _fixture.Create<UpdateCarCommand>();
            ...
            _CarRepository.Verify(x => x.UpdatePartial(It.IsAny<Car>()), Times.Never);
            _CarProducer.Verify(x => x.SendUpdatedEventAsync(It.IsAny<UpdatedCarEvent>()), Times.Never);
            _unitOfWork.Verify(x => x.CommitAsync(), Times.Never);
            _CarRepository.Verify(x => x.ExistsAsync(It.IsAny<string>(), It.IsAny<Guid>(), It.IsAny<Guid>()), Times.Once);
            _CarRepository.Verify(x => x.ExistsAsync(It.IsAny<Guid>()), Times.Once);
        ...
        public async Task Car_Should_Not_Be_Updated_When_Not_Exists()
        {
            ...
            _CarProducer.Verify(x => x.SendUpdatedEventAsync(It.IsAny<UpdatedCarEvent>()), Times.Never);
            _unitOfWork.Verify(x => x.CommitAsync(), Times.Never);
            _CarRepository.Verify(x => x.ExistsAsync(It.IsAny<string>(), It.IsAny<Guid>(), It.IsAny<Guid>()), Times.Never);
            _CarRepository.Verify(x => x.ExistsAsync(It.IsAny<Guid>()), Times.Once);
        }
    }
}
